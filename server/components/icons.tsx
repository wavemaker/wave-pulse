...
export const SolarSettingsBoldIcon: React.FC<IconSvgProps> = (props) => {
  const scale = (props.scale as number) || 40,
    width = scale,
    height = scale;
  return (
    <svg
    ...
    >
      <g fill="none" stroke="currentColor" strokeWidth={1.5}>
        <circle cx={scale * 3 / 10} cy={scale * 3 / 10} r={scale / 10}></circle>
...
export const SaveDataIcon: React.FC<IconSvgProps> = (props) => {
  const scale = (props.scale as number) || 40,
    width = scale,
    height = scale;
  return (
...
export const IconBxsLeftArrow: React.FC<IconSvgProps> = (props) => {
  const scale = (props.scale as number) || 40,
  width = scale,
  height = scale;
  return (
    ...
    >
      <path 
        fill="currentColor" d="M4.431 12.822l13 9A1 1 0 0019 21V3a1 1 0 00-1.569-.823l-13 9a1.003 1.003 0 000 1.645z" />
    </svg>
  );
};

export const IconBxsDownArrow: React.FC<IconSvgProps> = (props) => {
  const scale = (props.scale as number) || 40,
  width = scale,
  height = scale;
  return (
    ...
    >
      <path 
        fill="currentColor" d="M11.178 19.569a.998.998 0 001.644 0l9-13A.999.999 0 0021 5H3a1.002 1.002 0 00-.822 1.569l9 13z" />
    </svg>
  );
};
...
export const  IconExport: React.FC<IconSvgProps> = (props: React.SVGProps<SVGSVGElement>) => {
  return (
...
export const  IconImport: React.FC<IconSvgProps> = (props: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg fill="none" viewBox="0 0 24 24" height="1em" width="1em" {...props}>
      <path
        fill="currentColor"
